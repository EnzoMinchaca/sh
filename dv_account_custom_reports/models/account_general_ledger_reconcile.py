...
class ReconcileLedgerCustomHandler(models.AbstractModel):   # Informe de conciliación PO
    _name = 'account.reconcile.ledger.report.handler'
    _description = 'Informe de conciliación PO'
